      ...
      <nav className="navbar bg-blend-soft-light bg-blue-500 z-10">
        <div className="container-fluid">
          <a className="navbar-brand">
            <b className="text-3xl text-yellow-500 drop-shadow-[4px_4px_2px_rgba(0,0,0,1)]">
              BookTown
            </b>
          </a>
          <form className="d-flex" role="search">
            ...
            />
            <button
              className="btn btn-warning text-white bg-yellow-400"
              type="button"
            >
              Search
            </button>
        ...
        <div className="absolute inset-10 mt-40 bg-transparent bg-opacity-50 flex items-center justify-center">
          ...
          <div className="text-center text-yellow-500 max-w-4xl p-6">
            ...
            <h1 className="text-5xl md:text-6xl font-extrabold mb-4 drop-shadow-[4px_4px_2px_rgba(0,0,0,1)] text-[#FFC107]">
              Booktown Wonderland <br />A Magical Book Hub for Toddlers
            </h1>
            {/* <p className="text-lg md:text-xl font-bold text-white drop-shadow-md leading-relaxed"> */}
            <p
              className="text-lg md:text-xl font-extrabold leading-relaxed
     text-slate-100 drop-shadow-[4px_4px_2px_rgba(0,0,0,1)]
       "
            >
              Welcome to Booktown Wonderland, a delightful and easy-to-use book
              management app designed especially for toddlers. With a carefully
              curated collection of enchanting bedtime stories, this app lets
              parents and caregivers effortlessly manage, discover, and share
              the best bedtime stories for young children.
            </p>
          </div>
        </div>
      </div>
